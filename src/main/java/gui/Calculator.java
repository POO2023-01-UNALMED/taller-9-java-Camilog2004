...
public class Calculator extends VBox implements EventHandler<ActionEvent> {
	...
	public void handle(ActionEvent event) {
		...
		//Según el boton que se presione se realizara algo diferente
		switch (value) {
			case "0":
				if (operator == null) {
			...
			case "=":
				...
				try {
					switch (operator) {
						case "+":
							resultado=Float.toString(Float.parseFloat(number1) + Float.parseFloat(number2));
				...
				//Si hay un error que lo informe
